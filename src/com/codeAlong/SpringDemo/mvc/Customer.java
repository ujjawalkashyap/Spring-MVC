...
import com.codeAlong.SpringDemo.mvc.validation.CourseCode;
...
public class Customer {
	...
	@Pattern(regexp="^[a-zA-Z0-9]{6}", message="only 6 characters")
	private String postalCode;
	
	@CourseCode(value="START", message="must start with START")
